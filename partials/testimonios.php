<section class="px-5 bg-light" id="testimonios">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 mr-auto my-5">
            <h1 class="font-weight-bold text-orange text-center display-3">TESTIMONIOS</h1>
        </div>
        <div id="carousel-testimonio" class="carousel slide col-lg-12 col-md-12 col-sm-12 text-center pb-5" data-ride="carousel">
            <div class="carousel-inner parrafo text-azul-osc font-weight-bold">
                <div class="carousel-item active">
                    ...
                    <br>
                    <h4 class="font-weight-bold">- David Aristizábal.</h4>
                </div>
                <div class="carousel-item">
                    ...
                    <br>
                    <h4 class="font-weight-bold">- Victor Henao.</h4>
                </div>
                <div class="carousel-item">
                    ...
                    <br>
                    <h4 class="font-weight-bold">- Carolina Vásquez.</h4>
                </div>
            </div>
        </div>
    </div>
